---
name: enneagram-architect
description: Brainstorm and create characters from scratch using Enneagram psychology. Use at the beginning of story development to select optimal Enneagram types for protagonists, antagonists, and supporting cast, then position them against each other for maximum dramatic conflict. Helps build moral components, design opposition, and structure character relationships. Triggers on phrases like "help me create characters," "what Enneagram type should my protagonist be," "brainstorm character types for my story," "how should I position these characters against each other," "design my antagonist," "build a cast," or "what types work for this genre/theme."
---
...
1. Select optimal Enneagram types based on genre, theme, and story needs
2. Build fully-realized character psychology from type foundations
3. Position characters against each other (opponents, allies, lovers, mentors)
4. Construct the moral component that drives your story
...
**Selection Criteria:**
1. **Thematic fit:** Which type's core struggle embodies your theme?
2. **Genre fit:** Which type's fears/desires align with genre stakes?
3. **Arc potential:** Which type's evolution/de-evolution serves the story you want to tell?
...
- Seven protagonist → One-ish opponent (rigid, critical, trapping)
- Eight protagonist → Five-ish opponent (withdrawn, intellectual, refuses to engage)
- Nine protagonist → Six-ish opponent (anxious, demanding, forces choices)

**Opponent Construction**
- How do they specifically target the protagonist's blind spot?
- How do they exploit the protagonist's pinches?
- How do they use the protagonist's distortion filters against them?
- How do they block the protagonist's evolution path?

### Phase 5: Build Supporting Cast

**Ally Design**
Using `references/relationship-dynamics.md`:
- Who models the protagonist's evolution point?
- Who provides wing resources when needed?
- Beware false allies who enable the blind spot

**Mentor Design**
- Should embody what protagonist needs to learn
- Healthy version of protagonist's type OR their evolution point
- Can be flawed—mentor's own type struggle creates texture

**Love Interest Design**
- What type creates both attraction AND conflict?
- What does each type seek in love? Does this pairing deliver and frustrate?
- How does the romantic dynamic serve the protagonist's arc?

**Ensemble Balance**
- Mix emotional centers (Head, Heart, Body)
- Mix harmonic triads (Positive Outlook, Reactive, Competency)
- Ensure no story function is missing

### Phase 6: Relationship Positioning
