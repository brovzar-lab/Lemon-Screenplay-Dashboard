...
const english = {
  ...
  unknown_proprietary: 'unknown or proprietary',
...
const spanish = {
  ...
  'Story spine': 'Columna vertebral de la historia',
  'Want': 'Deseo',
  'Need': 'Necesidad',
  ...
  'Development priorities': 'Prioridades de desarrollo',
  'Continuity flags': 'Alertas de continuidad',
  'The case for': 'El caso a favor',
  ...
  'Intelligence Briefing': 'Briefing de Inteligencia',
  'Briefing unavailable': 'Briefing no disponible',
  'Lemon team access required': 'Se requiere acceso del equipo Lemon',
  'This account is signed in but is not authorized to read the private Lemon portfolio.':
    'Esta cuenta inició sesión, pero no tiene autorización para leer el portafolio privado de Lemon.',
  'The reviewed research artifact did not pass validation. No market decision is shown.':
    'El artefacto de investigación revisado no pasó la validación. No se muestra ninguna decisión de mercado.',
  'Lemon Studios · Mexico': 'Lemon Studios · México',
  'A reviewed decision surface. Intelligence advises; Billy owns the executive and creative decision.':
    'Una superficie de decisión revisada. La inteligencia asesora; Billy conserva la decisión ejecutiva y creativa.',
  ...
  Situation: 'Situación',
  'What we know, and what we do not': 'Lo que sabemos y lo que no',
  'Mexico is the decision territory. Regional, diaspora, Spain, and global evidence stays labeled as context.':
    'México es el territorio de decisión. La evidencia regional, de diáspora, de España y global permanece etiquetada como contexto.',
  'Three Moves': 'Tres movimientos',
  'Ranked decisions supported by this issue': 'Decisiones priorizadas que respalda esta edición',
  'The briefing publishes zero to three moves. It never fills the layout with unsupported decisions.':
    'El briefing publica de cero a tres movimientos. Nunca llena el diseño con decisiones sin respaldo.',
  'No ranked market move is supported by this issue. Keep decisions unranked until the evidence contract is satisfied.':
    'Esta edición no respalda ningún movimiento de mercado priorizado. Mantén las decisiones sin rango hasta que se cumpla el contrato de evidencia.',
  'Ranked market actions': 'Acciones de mercado priorizadas',
  advance: 'avanzar',
  investigate: 'investigar',
  acquire: 'adquirir',
  watch: 'vigilar',
  dismiss: 'descartar',
  'Strongest support': 'Respaldo más fuerte',
  'Strongest contradiction': 'Contradicción más fuerte',
  'None recorded': 'Ninguna registrada',
  'Audience Ninja claim': 'Clasificación de Audience Ninja',
  'Next action': 'Siguiente acción',
  'Reverse when': 'Revertir cuando',
  confirmed: 'confirmado',
  strong_inference: 'inferencia sólida',
  speculation: 'especulación',
  unknown_proprietary: 'desconocido o propietario',
  'Insufficient evidence': 'Evidencia insuficiente',
  'Mexico Now': 'México ahora',
  'Open buyer doors': 'Puertas abiertas con compradores',
  'Public evidence only. A visible strategy signal is not a private buying mandate.':
    'Solo evidencia pública. Una señal visible de estrategia no es un mandato privado de compra.',
  'Mexico buyer context': 'Contexto de compradores en México',
  open: 'abierta',
  limited: 'limitada',
  'Zeitgeist + Context': 'Zeitgeist + contexto',
  'Conversation beside verified evidence': 'Conversación junto a evidencia verificada',
  'Conversation, verified context, and observed outcomes remain separate. No blended truth score is calculated.':
    'La conversación, el contexto verificado y los resultados observados permanecen separados. No se calcula una calificación combinada de verdad.',
  'Zeitgeist and verified context': 'Zeitgeist y contexto verificado',
  connector_unavailable: 'conector no disponible',
  conversation: 'conversación',
  Conversation: 'Conversación',
  'Verified context': 'Contexto verificado',
  'Observed outcomes': 'Resultados observados',
  'Unavailable. No volume or sentiment was fabricated.':
    'No disponible. No se fabricó volumen ni sentimiento.',
  Available: 'Disponible',
  'Does not prove': 'No demuestra',
  'Alternative explanations': 'Explicaciones alternativas',
  'Source families': 'Familias de fuentes',
  ...
  official: 'oficial',
  government: 'gobierno',
  trade_press: 'prensa especializada',
  measurement: 'medición',
  industry: 'industria',
  'Next confirming test': 'Siguiente prueba de confirmación',
  'Source receipts and methodology': 'Comprobantes de fuentes y metodología',
  'All source pages are treated as untrusted data. Embedded instructions are ignored; social evidence may be published only in aggregate.':
    'Todas las páginas fuente se tratan como datos no confiables. Se ignoran las instrucciones incrustadas; la evidencia social solo puede publicarse de forma agregada.',
  'Portfolio Opportunity': 'Oportunidad de portafolio',
  'Creative quality beside market timing': 'Calidad creativa junto al momento de mercado',
  'Private titles join locally only after team authorization. Paperclip never receives slate data.':
    'Los títulos privados se cruzan localmente solo después de la autorización del equipo. Paperclip nunca recibe datos de la selección.',
  'Portfolio Opportunity Map': 'Mapa de oportunidades del portafolio',
  'Loading authorized portfolio…': 'Cargando el portafolio autorizado…',
  'Portfolio authorization failed. No slate decision is shown.':
    'Falló la autorización del portafolio. No se muestra ninguna decisión sobre la selección.',
  'Portfolio data is unavailable. This is not an empty-slate signal.':
    'Los datos del portafolio no están disponibles. Esto no significa que la selección esté vacía.',
  'The authorized slate query succeeded and returned no projects.':
    'La consulta autorizada de la selección terminó correctamente y no devolvió proyectos.',
  'Acquisition gaps': 'Vacíos de adquisición',
  'No verified project matches the reviewed criteria. No project was manufactured.':
    'Ningún proyecto verificado coincide con los criterios revisados. No se inventó ningún proyecto.',
  'Creative score stays on its existing verified scale. Market timing is a reviewed band, not a demand score, and it never changes a screenplay verdict.':
    'La calificación creativa permanece en su escala verificada existente. El momento de mercado es una banda revisada, no una calificación de demanda, y nunca cambia el veredicto de un guion.',
  'Authorized portfolio opportunity table': 'Tabla autorizada de oportunidades del portafolio',
  'Matched projects': 'Proyectos coincidentes',
  'Unmatched projects': 'Proyectos sin coincidencia',
  'Unrankable projects': 'Proyectos no clasificables',
  Project: 'Proyecto',
  'Verified creative score': 'Calificación creativa verificada',
  'Market timing': 'Momento de mercado',
  'Market action': 'Acción de mercado',
  'Market claim': 'Afirmación de mercado',
  'Match status': 'Estado de coincidencia',
  Unrankable: 'No clasificable',
  wait: 'esperar',
  emerging: 'emergente',
  active: 'activa',
  immediate: 'inmediata',
  to: 'a',
  'No matched timing band': 'Sin banda de momento coincidente',
  'No market match': 'Sin coincidencia de mercado',
  'Not applicable': 'No aplica',
  'Approximate text match': 'Coincidencia aproximada de texto',
  'No reviewed match': 'Sin coincidencia revisada',
  'Keep creative review separate': 'Mantener separada la revisión creativa',
  'Evidence Health': 'Salud de la evidencia',
  'Seven separate checks, no confidence score': 'Siete revisiones separadas, sin calificación de confianza',
  'Every weakest dimension stays visible, including ties.':
    'Cada dimensión más débil permanece visible, incluidos los empates.',
  'Evidence health dimensions': 'Dimensiones de salud de la evidencia',
  'Weakest evidence': 'Evidencia más débil',
  'Stale sources': 'Fuentes vencidas',
  'Unresolved contradictions': 'Contradicciones sin resolver',
  'Missing connectors': 'Conectores faltantes',
  unavailable: 'no disponible',
  licensing_pending: 'licencia pendiente',
  directness: 'acceso directo',
  provenance: 'procedencia',
  independence: 'independencia',
  coverage: 'cobertura',
  freshness: 'vigencia',
  contradiction: 'contradicción',
  knowledgeLimits: 'límites de conocimiento',
  good: 'buena',
  caution: 'precaución',
  weak: 'débil',
  'Decision & Prediction Ledger': 'Registro de decisiones y predicciones',
  'Not enough history': 'No hay historial suficiente',
  ...
  'TV Pilot': 'Piloto de TV',
  'Queue connection lost. Uploaded files remain safe; reconnecting.': 'Se perdió la conexión con la cola. Los archivos subidos siguen a salvo; reconectando.',
  'Reconnecting to the accepted upload. No new analysis was requested.': 'Reconectando con el archivo recibido. No se solicitó otro análisis.',
  'Upload receipt could not be checked. No new upload was sent.': 'No se pudo comprobar la recepción del archivo. No se envió otra carga.',
  'Upload failed. Intake will reconnect if the file was accepted.': 'Falló la carga. Ingreso se reconectará si el archivo fue recibido.',
  'Waiting for the Coverage worker': 'Esperando al procesador de cobertura',
  'Coverage connection lost. Keeping reports and reconnecting.': 'Se perdió la conexión de cobertura. Conservamos los informes y reconectamos.',
  'Needs Review · provisional coverage': 'Requiere revisión · cobertura provisional',
  'Human review': 'Revisión humana',
  'Human review is required before using this coverage for a production decision.': 'Se requiere revisión humana antes de usar esta cobertura para una decisión de producción.',
  'Upload screenplays, follow their progress, and read Coverage V1.2 drafts with visible uncertainty. Every new report requires human review before a production decision.': 'Carga guiones, sigue su progreso y lee borradores de Cobertura V1.2 con sus incertidumbres visibles. Cada informe nuevo requiere revisión humana antes de una decisión de producción.',
  'A complete reading and a separate model review. Every new Coverage report stays in Needs Review for human judgment.': 'Una lectura completa y una revisión separada por un modelo. Cada informe nuevo permanece en Requiere revisión para el criterio humano.',
  'A model review is not human approval. Read the report and its uncertainties before deciding.': 'La revisión de un modelo no es aprobación humana. Lee el informe y sus incertidumbres antes de decidir.',
  'Coverage V1.2 runs after confirmation. New reports remain provisional and available for human review.': 'Cobertura V1.2 se ejecuta tras la confirmación. Los informes nuevos permanecen provisionales y disponibles para revisión humana.',
  'Independent review': 'Revisión independiente',
  'Human taste': 'Criterio creativo',
  'Uncertain fact': 'Hecho incierto',
  'Factual correction': 'Corrección factual',
  'Upload progress': 'Progreso de carga',
  'A newer report is shown for this project.': 'Se muestra un informe más reciente para este proyecto.',
  'Replacement accepted. The old issue could not be dismissed; do not upload again.': 'Reemplazo aceptado. No se pudo descartar la incidencia anterior; no vuelvas a subirlo.',
  'Replacement not confirmed. Check Intake before trying again.': 'Reemplazo sin confirmar. Revisa Ingreso antes de volver a intentarlo.',
  'Report saved. Waiting for this version to appear on the dashboard.': 'Informe guardado. Esperando a que esta versión aparezca en el tablero.',
  'A complete reading and separate fact-check. Unresolved questions stay visible in Needs Review.': 'Una lectura completa y una revisión factual separada. Las dudas pendientes permanecen visibles en Requiere revisión.',
  'Ready means checked, not infallible. Human judgment remains essential.': 'Listo significa revisado, no infalible. El criterio humano sigue siendo esencial.',
  'Coverage V1.2 runs after confirmation. Useful drafts remain available even when they need human review.': 'Cobertura V1.2 se ejecuta tras la confirmación. Los borradores útiles siguen disponibles aunque requieran revisión humana.',
  'Coverage was saved with unresolved questions. Open it from Intake to read the report and review notes. Do not repeat paid analysis to fix a connection problem.': 'La cobertura se guardó con dudas pendientes. Ábrela desde Ingreso para leer el informe y sus notas. No repitas un análisis de pago para resolver un problema de conexión.',
  'Coverage reanalysis uses Intake: upload the PDF and choose its project revision. This V9 action cannot replace Coverage.': 'Para volver a analizar una cobertura, sube el PDF en Ingreso y selecciona la revisión del proyecto. Esta acción V9 no puede reemplazar una cobertura.',
} as const;
