...
import { buildShareableUrl, copyShareableUrl } from './useUrlState';
...
describe('copyShareableUrl', () => {
  ...
  it('shows a localized warning when the clipboard rejects the copy', async () => {
    ...
    await expect(copyShareableUrl()).resolves.toBe(false);
