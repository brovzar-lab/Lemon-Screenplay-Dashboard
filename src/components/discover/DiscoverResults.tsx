...
export function DiscoverShowcase({ featured, topMatches }: DiscoverShowcaseProps) {
  return (
    <section
          ...
          <ol className="grid gap-3 sm:grid-cols-2">
            {topMatches.map((screenplay, index) => (
              <li
                ...
                className={clsx(
                  'group flex min-h-44 gap-4 border bg-black-900 p-3 transition-colors hover:bg-black-800',
...
export function DiscoverGrid({ screenplays }: { screenplays: Screenplay[] }) {
    ...
    <ul className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      {screenplays.map((screenplay, index) => (
        <li
          ...
          data-screenplay-id={screenplay.id}
          className={clsx(
            'relative flex min-h-72 flex-col overflow-hidden border bg-black-900 p-5 transition-colors hover:bg-black-800',
            TIER_BORDERS[screenplay.recommendation],
          )}
        >
          <div className="flex items-start justify-between gap-4">
