 ...
 *
 * Compare analysis results across engines (V6 Classic / V7 Archaeology)
 * and models (Haiku / Sonnet / Opus). Supports two source modes:
 *   1. Upload — drop a PDF and run fresh analysis
...
function getDimensionScoresV6(analysis: Record<string, unknown>): { label: string; score: number }[] {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-black-400 mt-1">
          Compare analysis engines (V6/V7) and AI models side-by-side.
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <p className="text-xs text-black-500 uppercase tracking-wider">
                        {engine.id === 'v7' ? 'Pillars (V7)' : 'Dimensions (V6)'}
                      </p>
                      {getResultDimensions(r, engine.id).map((d) => (
