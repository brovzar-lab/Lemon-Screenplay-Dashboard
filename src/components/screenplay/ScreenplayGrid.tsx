...
function EmptyState({ hasFilters }: { hasFilters: boolean }) {
  return (
    <div className="col-span-full flex flex-col items-center justify-center py-16 text-center">
      ...
      <h3 className="text-xl font-display text-gold-100 mb-2">
        {hasFilters ? 'No Screenplays Match' : 'No Screenplays Found'}
      </h3>
      <p className="text-black-400 max-w-md">
        {hasFilters
          ? 'Try adjusting your filters or search query to find more screenplays.'
