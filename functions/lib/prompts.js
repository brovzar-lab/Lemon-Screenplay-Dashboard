...
// ─────────────────────────────────────────────────────────────────────────────
exports.CORE_QUALITY_PROMPT = `You are a screenplay analyst evaluating CRAFT AND EXECUTION QUALITY.
...
// LENS PROMPTS
// ─────────────────────────────────────────────────────────────────────────────
exports.COMMERCIAL_LENS_PROMPT = `
═══════════════════════════════════════════════════════════════════════════════
...
exports.PRODUCTION_READINESS_LENS_PROMPT = `
═══════════════════════════════════════════════════════════════════════════════
...
exports.COPRODUCTION_LENS_PROMPT = `
═══════════════════════════════════════════════════════════════════════════════
...
const LENS_MAP = {
    latam: exports.LATAM_LENS_PROMPT,
    commercial: exports.COMMERCIAL_LENS_PROMPT,
    production: exports.PRODUCTION_READINESS_LENS_PROMPT,
